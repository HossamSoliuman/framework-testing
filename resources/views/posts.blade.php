...
@section('content')
    {{-- <div class="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <button type="button" class="mb-3 px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600" id="openCreateModal">
            Create a new Post
        </button>

        <!-- Create Post Modal -->
        <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 hidden" id="createModal">
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
                <div class="px-6 py-4">
                    ...
                    <form action="{{ route('posts.store') }}" method="post">
                        ...
                        <div class="mt-4">
                            <input type="number" name="likes_count" class="w-full p-2 border border-gray-300 rounded"
                                placeholder="Post likes_count" required>
                        </div>
                </div>
                <div class="flex justify-end p-4 bg-gray-50">
                    <button class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600"
                        type="submit">Submit</button>
                    <button class="ml-2 bg-gray-300 px-4 py-2 rounded hover:bg-gray-400"
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-md w-full">
                <div class="px-6 py-4">
                    ...
                    <form id="editForm" method="post">
                        ...
                        <div class="mt-4">
                            <input type="text" name="likes_count" class="w-full p-2 border border-gray-300 rounded"
                                placeholder="Post likes_count" required>
                        </div>
                </div>
                <div class="flex justify-end p-4 bg-gray-50">
                    <button class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600" id="saveChangesBtn">Save
                        Changes</button>
                    <button class="ml-2 bg-gray-300 px-4 py-2 rounded hover:bg-gray-400" id="closeEditModal">Close</button>
                </form>
            ...
            <tbody>
                @foreach ($posts as $post)
                    <tr data-post-id="{{ $post->id }}">
                        ...
                        <td>
                            <button type="button"
                                class="px-4 py-2 bg-yellow-500 text-white rounded-lg hover:bg-yellow-600 btn-edit">
                                Edit
                            </button>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.btn-edit').forEach(button => {
                button.addEventListener('click', function() {
                    var postName = this.closest('tr').querySelector('.post-name').textContent;
                    var postLikesCount = this.closest('tr').querySelector('.post-likes_count')
                        .textContent;
                    var postId = this.closest('tr').dataset.postId;

                    document.querySelector('#editModal input[name="name"]').value = postName;
                    document.querySelector('#editModal input[name="likes_count"]').value =
                        postLikesCount;
                    document.querySelector('#editForm').setAttribute('action', '/posts/' + postId);
